...
interface Props {
  groupName: string;
  items: string[];
  onUpdate: (groupName: string, items: string[]) => Promise<void>;
}

export default function ExerciseGroupEditor({ groupName, items, onUpdate }: Props) {
